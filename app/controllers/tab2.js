...
var remotecallbackuri = "hivewallethivekeychain";
var sessionxrf = helpers.generateBase58Password(10).toLowerCase();

// see the unminified version of this code in /lib/steemkeychainreference/steem_keychain.js
var inlinecode_ios = 'var hive_keychain={current_id:1,requests:{},handshake_callback:null,requestHandshake:function(e){hive_keychain.handshake_callback=e,hive_keychain.dispatchCustomEvent("swHandshake","")},requestVerifyKey:function(e,t,s,n){var a={type:"decode",username:e,message:t,method:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestSignBuffer:function(e,t,s,n){var a={type:"signBuffer",username:e,message:t,method:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestAddAccountAuthority:function(e,t,s,n,a){var o={type:"addAccountAuthority",username:e,authorizedUsername:t,role:s,weight:n,method:"Active"};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestRemoveAccountAuthority:function(e,t,s,n){var a={type:"removeAccountAuthority",username:e,authorizedUsername:t,role:s,method:"Active"};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestBroadcast:function(e,t,s,n){var a={type:"broadcast",username:e,operations:t,method:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestSignedCall:function(e,t,s,n,a){var o={type:"signedCall",username:e,method:t,params:s,typeWif:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestPost:function(e,t,s,n,a,o,i,u,r){var c={type:"post",username:e,title:t,body:s,parent_permlink:n,parent_author:a,json_metadata:o,permlink:i,comment_options:u};hive_keychain.dispatchCustomEvent("swRequest",c,r)},requestVote:function(e,t,s,n,a){var o={type:"vote",username:e,permlink:t,author:s,weight:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestCustomJson:function(e,t,s,n,a,o){var i={type:"custom",username:e,id:t,method:s,json:n,display_msg:a};hive_keychain.dispatchCustomEvent("swRequest",i,o)},requestTransfer:function(e,t,s,n,a,o,i){var u={type:"transfer",username:e,to:t,amount:s,memo:n,enforce:i||!1,currency:a};hive_keychain.dispatchCustomEvent("swRequest",u,o)},requestSendToken:function(e,t,s,n,a,o){var i={type:"sendToken",username:e,to:t,amount:s,memo:n,currency:a};hive_keychain.dispatchCustomEvent("swRequest",i,o)},requestDelegation:function(e,t,s,n,a){var o={type:"delegation",username:e,delegatee:t,amount:s,unit:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestWitnessVote:function(e,t,s,n){var a={type:"witnessVote",username:e,witness:t,vote:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestPowerUp:function(e,t,s,n){var a={type:"powerUp",username:e,recipient:t,hive:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestPowerDown:function(e,t,s){var n={type:"powerDown",username:e,steem_power:t};hive_keychain.dispatchCustomEvent("swRequest",n,s)},requestCreateProposal:function(e,t,s,n,a,o,i,u,r){var c={type:"createProposal",username:e,receiver:t,subject:s,permlink:n,start:o,end:i,daily_pay:a,extensions:u};hive_keychain.dispatchCustomEvent("swRequest",c,r)},requestRemoveProposal:function(e,t,s,n){var a={type:"removeProposal",username:e,proposal_ids:t,extensions:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestUpdateProposalVote:function(e,t,s,n,a){var o={type:"updateProposalVote",username:e,proposal_ids:t,approve:s,extensions:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},dispatchCustomEvent:function(e,t,s){hive_keychain.requests[hive_keychain.current_id]=s;var n={name:e,data:t,detail:{request_id:hive_keychain.current_id}};hive_keychain.current_id++,document.location="hivewallethivekeychain://?params="+encodeURIComponent(JSON.stringify(n))},postMessage:function(e){console.log("received PostMessage"),console.log(e);var t,s=JSON.parse(decodeURIComponent(e));s.data.type&&"hive_keychain_response"==s.data.type?(t=s.data.response,console.log("response object = "),console.log(t),t&&t.request_id&&(console.log("will now try to execute hive_keychain.requests["+t.request_id+"]"),hive_keychain.requests[t.request_id]?(hive_keychain.requests[t.request_id](t),delete hive_keychain.requests[t.request_id]):console.log("no such request"))):s.data.type&&"hive_keychain_handshake"==s.data.type&&hive_keychain.handshake_callback&&hive_keychain.handshake_callback()}};!function(t){var s=t.pushState;t.pushState=function(e){return"function"==typeof t.onpushstate&&t.onpushstate({state:e}),s.apply(t,arguments)}}(window.history),window.onpopstate=history.onpushstate=function(e){setTimeout(function(){e.windowlocation=window.location.href,hive_keychain.dispatchCustomEvent("swPopstate",e)},500)};';

var inlinecode_android = 'var hive_keychain={current_id:1,requests:{},handshake_callback:null,requestHandshake:function(e){hive_keychain.handshake_callback=e,hive_keychain.dispatchCustomEvent("swHandshake","")},requestVerifyKey:function(e,t,s,n){var a={type:"decode",username:e,message:t,method:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestSignBuffer:function(e,t,s,n){var a={type:"signBuffer",username:e,message:t,method:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestAddAccountAuthority:function(e,t,s,n,a){var o={type:"addAccountAuthority",username:e,authorizedUsername:t,role:s,weight:n,method:"Active"};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestRemoveAccountAuthority:function(e,t,s,n){var a={type:"removeAccountAuthority",username:e,authorizedUsername:t,role:s,method:"Active"};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestBroadcast:function(e,t,s,n){var a={type:"broadcast",username:e,operations:t,method:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestSignedCall:function(e,t,s,n,a){var o={type:"signedCall",username:e,method:t,params:s,typeWif:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestPost:function(e,t,s,n,a,o,i,u,r){var c={type:"post",username:e,title:t,body:s,parent_permlink:n,parent_author:a,json_metadata:o,permlink:i,comment_options:u};hive_keychain.dispatchCustomEvent("swRequest",c,r)},requestVote:function(e,t,s,n,a){var o={type:"vote",username:e,permlink:t,author:s,weight:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestCustomJson:function(e,t,s,n,a,o){var i={type:"custom",username:e,id:t,method:s,json:n,display_msg:a};hive_keychain.dispatchCustomEvent("swRequest",i,o)},requestTransfer:function(e,t,s,n,a,o,i){var u={type:"transfer",username:e,to:t,amount:s,memo:n,enforce:i||!1,currency:a};hive_keychain.dispatchCustomEvent("swRequest",u,o)},requestSendToken:function(e,t,s,n,a,o){var i={type:"sendToken",username:e,to:t,amount:s,memo:n,currency:a};hive_keychain.dispatchCustomEvent("swRequest",i,o)},requestDelegation:function(e,t,s,n,a){var o={type:"delegation",username:e,delegatee:t,amount:s,unit:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},requestWitnessVote:function(e,t,s,n){var a={type:"witnessVote",username:e,witness:t,vote:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestPowerUp:function(e,t,s,n){var a={type:"powerUp",username:e,recipient:t,hive:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestPowerDown:function(e,t,s){var n={type:"powerDown",username:e,steem_power:t};hive_keychain.dispatchCustomEvent("swRequest",n,s)},requestCreateProposal:function(e,t,s,n,a,o,i,u,r){var c={type:"createProposal",username:e,receiver:t,subject:s,permlink:n,start:o,end:i,daily_pay:a,extensions:u};hive_keychain.dispatchCustomEvent("swRequest",c,r)},requestRemoveProposal:function(e,t,s,n){var a={type:"removeProposal",username:e,proposal_ids:t,extensions:s};hive_keychain.dispatchCustomEvent("swRequest",a,n)},requestUpdateProposalVote:function(e,t,s,n,a){var o={type:"updateProposalVote",username:e,proposal_ids:t,approve:s,extensions:n};hive_keychain.dispatchCustomEvent("swRequest",o,a)},dispatchCustomEvent:function(e,t,s){hive_keychain.requests[hive_keychain.current_id]=s;var n={name:e,data:t,detail:{request_id:hive_keychain.current_id}};hive_keychain.current_id++;var a=new XMLHttpRequest,o=window.location.origin;"/"!=o.slice(-1)&&(o+="/");var i=o+"?xrf=hivewallethivekeychain&params="+encodeURIComponent(JSON.stringify(n));a.open("HEAD",i),a.send()},postMessage:function(e){console.log("received PostMessage"),console.log(e);var t,s=JSON.parse(decodeURIComponent(e));s.data.type&&"hive_keychain_response"==s.data.type?(t=s.data.response,console.log("response object = "),console.log(t),t&&t.request_id&&(console.log("will now try to execute hive_keychain.requests["+t.request_id+"]"),hive_keychain.requests[t.request_id]?(hive_keychain.requests[t.request_id](t),delete hive_keychain.requests[t.request_id]):console.log("no such request"))):s.data.type&&"hive_keychain_handshake"==s.data.type&&hive_keychain.handshake_callback&&hive_keychain.handshake_callback()}};!function(t){var s=t.pushState;t.pushState=function(e){return"function"==typeof t.onpushstate&&t.onpushstate({state:e}),s.apply(t,arguments)}}(window.history),window.onpopstate=history.onpushstate=function(e){setTimeout(function(){e.windowlocation=window.location.href,hive_keychain.dispatchCustomEvent("swPopstate",e)},500)};';

function postSteemKeyCommand(obj) {
	console.log('trying to post Hive Command');
	console.log(obj);
...
function unlockAndSign(){
	...
	if(current_query_object['data']['type'] == "signBuffer") {
		...
		// 				replaceoperation[1]['amount'] = replaceoperation[1]['amount'].replace(" SBD"," HBD").replace(" STEEM"," HIVE").replace(" SP", " HP");
		// 			}
		// 		} catch(replacerr) {
		...
		// end workaround;
		console.log("+ - - - - - -  - - - - - - +");
		console.log("|  logging operation here  |");
		console.log("+ - - - - - -  - - - - - - +");
		console.log(current_query_object['data']);
		console.log("+ - - - - - -  - - - - - - +");
		console.log(current_query_object['operations']);
...
function handleSteemKeyCommand(_url) {
	...
	if(parsedcommand.parsedURI.queryKey.hasOwnProperty('params')) {
		...
		} else if(queryobject['name'] == "swPopstate") {
			console.log("\n\nswPopstate called in app");
			console.log(queryobject);

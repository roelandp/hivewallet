		...
		case 'post':
			current_query_object['operations'] = [[
				"comment",
				{
					...
					json_metadata: current_query_object['data']['json_metadata']
				}
			]];
		break;

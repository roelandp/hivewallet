...
var slowaesopts = { iv: (Ti.Utils.sha1(Ti.App.Properties.getString('uuid'))).substring(7, 23) };
...
function encryptWallet(keys, passphrase) {
	...
	var wallettext = JSON.stringify({ ciphertext: encryptedValue });
			...
			function (response) {
				...
				helpers.steemAPIcall(
					...
					function (transactionresponse) {
						...
						} else if ('block_num' in answerfromchain) {
						...
						var timeout1 = setTimeout(function () { updateAccount(from); timeout1 = null; }, 4000);
